...
namespace Fusin
{
	const IOType IO_NINTENDO_BUTTON = IO_NINTENDO | IO_BUTTON;
	const IOType IO_NINTENDO_AXIS = IO_NINTENDO | IO_AXIS;
	const IOType IO_NINTENDO_DPAD_ANGLE = IO_NINTENDO | IO_ANGLE;
	const IOType IO_NINTENDO_DPAD_BUTTON = IO_NINTENDO | IO_DIRECTION;

	const IOType IO_NINTENDO_GYRO = IO_NINTENDO | IO_GYRO;
	const IOType IO_NINTENDO_ACCELERATION = IO_NINTENDO | IO_ACCELERATION;
	const IOType IO_NINTENDO_POSITION = IO_NINTENDO | IO_POSITION;
	const IOType IO_NINTENDO_ORIENTATION = IO_NINTENDO | IO_ORIENTATION;
	const IOType IO_NINTENDO_VELOCITY = IO_NINTENDO | IO_VELOCITY;

	const IOType IO_NINTENDO_SIGNED_AXIS = IO_NINTENDO_AXIS | IO_SIGNED_VERSION;
	const IOType IO_NINTENDO_SIGNED_GYRO = IO_NINTENDO_GYRO | IO_SIGNED_VERSION;
	const IOType IO_NINTENDO_SIGNED_ACCELERATION = IO_NINTENDO_ACCELERATION | IO_SIGNED_VERSION;
	const IOType IO_NINTENDO_SIGNED_POSITION = IO_NINTENDO_POSITION | IO_SIGNED_VERSION;
	const IOType IO_NINTENDO_SIGNED_ORIENTATION = IO_NINTENDO_ORIENTATION | IO_SIGNED_VERSION;
	const IOType IO_NINTENDO_SIGNED_VELOCITY = IO_NINTENDO_VELOCITY | IO_SIGNED_VERSION;
	...
	*/
	...
	const IOCode NINTENDO_POSITION_X = IOCode(DT_NINTENDO, IO_POSITION, 0);
	const IOCode NINTENDO_POSITION_Y = IOCode(DT_NINTENDO, IO_POSITION, 1);
	const IOCode NINTENDO_POSITION_Z = IOCode(DT_NINTENDO, IO_POSITION, 2);
