...
namespace Fusin
{
	...
	*/
	...
	const IOCode NINTENDO_VIBRATION_LEFT_FORCE      = IOCode(DT_NINTENDO, IO_VIBRATION, 0);
	const IOCode NINTENDO_VIBRATION_LEFT_AMPLITUDE  = IOCode(DT_NINTENDO, IO_VIBRATION, 1);
	const IOCode NINTENDO_VIBRATION_LEFT_DURATION   = IOCode(DT_NINTENDO, IO_VIBRATION, 2);
	const IOCode NINTENDO_VIBRATION_RIGHT_FORCE     = IOCode(DT_NINTENDO, IO_VIBRATION, 3);
	const IOCode NINTENDO_VIBRATION_RIGHT_AMPLITUDE = IOCode(DT_NINTENDO, IO_VIBRATION, 4);
	const IOCode NINTENDO_VIBRATION_RIGHT_DURATION  = IOCode(DT_NINTENDO, IO_VIBRATION, 5);
