...
namespace Fusin
{
	...
	*/
	...
	const IOCode DS_LED_1 = IOCode(DT_DUALSHOCK, IO_LEDS, 0);
	const IOCode DS_LED_2 = IOCode(DT_DUALSHOCK, IO_LEDS, 1);
	const IOCode DS_LED_3 = IOCode(DT_DUALSHOCK, IO_LEDS, 2);
	const IOCode DS_LED_4 = IOCode(DT_DUALSHOCK, IO_LEDS, 2);
	
	const IOCode DS_VIBRATION_LEFT_FORCE      = IOCode(DT_DUALSHOCK, IO_VIBRATION, 0);
	const IOCode DS_VIBRATION_LEFT_AMPLITUDE  = IOCode(DT_DUALSHOCK, IO_VIBRATION, 1);
	const IOCode DS_VIBRATION_LEFT_DURATION   = IOCode(DT_DUALSHOCK, IO_VIBRATION, 2);
	const IOCode DS_VIBRATION_RIGHT_FORCE     = IOCode(DT_DUALSHOCK, IO_VIBRATION, 3);
	const IOCode DS_VIBRATION_RIGHT_AMPLITUDE = IOCode(DT_DUALSHOCK, IO_VIBRATION, 4);
	const IOCode DS_VIBRATION_RIGHT_DURATION  = IOCode(DT_DUALSHOCK, IO_VIBRATION, 5);
